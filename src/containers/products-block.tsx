  ...
  return (
    <div className={className}>
      ...
      {error ? (
        ...
        <div
          className={cn(
            `grid gap-x-${demoVariant === 'ancient' ? 2 : 3} md:gap-x-${demoVariant === 'ancient' ? 2 : 5} xl:gap-x-${demoVariant === 'ancient' ? 2 : 7
            } gap-y-${demoVariant === 'ancient' ? 2 : 3} xl:gap-y-${demoVariant === 'ancient' ? 2 : 5} 2xl:gap-y-${demoVariant === 'ancient' ? 3 : 8
            } bg-white`,
            {
