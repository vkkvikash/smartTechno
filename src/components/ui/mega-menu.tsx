...
const MegaMenu: React.FC<MegaMenuProps> = ({ columns }) => {
	...
	return (
		<div className="absolute bg-gray-200 megaMenu shadow-header -start-28 xl:start-0" style={{ "width": "max-content" }}>
			<div className={`grid grid-cols-${columns[0].columnItems?.length || 5}`}>
				{columns?.map((column) => (
					<>
