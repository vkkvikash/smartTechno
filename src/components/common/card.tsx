    ...
    <Link href={href} className="group flex justify-center text-center flex-col">
      ...
      >
        <div className="flex">
          <Image
            unoptimized
            src={image !== "" ? image : "https://phplaravel-850897-2935237.cloudwaysapps.com/public/upload/categories/original/793087817-221129013653.png"}
            // alt={"https://phplaravel-850897-2935237.cloudwaysapps.com/public/upload/categories/original/793087817-221129013653.png"}
            alt={name || t('thumbnail')}
            width={imageSize}
            height={imageSize}
            quality={100}
